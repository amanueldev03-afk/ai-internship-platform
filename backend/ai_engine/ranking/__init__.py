...
Business spec weights (must sum to 1.0):
  skills          40%   — exact + semantic skill overlap
  field_of_study  20%   — education/field relevance
  career_interest 15%   — career goals match
  experience      10%   — past experience relevance
  location        10%   — location/work-mode preference
  work_mode        5%   — remote/onsite/hybrid preference
...
# Canonical weights per business spec
WEIGHTS = {
    "skill":           0.40,
    "field_of_study":  0.20,
