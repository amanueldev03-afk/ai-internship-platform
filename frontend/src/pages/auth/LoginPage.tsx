...
export default function LoginPage() {
  ...
  // Redirect authenticated users to intended destination or appropriate dashboard
  useEffect(() => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (login.fulfilled.match(result)) {
      ...
      console.log('Redirecting with role:', currentRole, 'from:', from)
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4 py-12 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-xl shadow-sm border border-gray-100">
        ...
        {isUnverifiedAccount && (
          <div className="rounded-lg bg-amber-50 p-4 border border-amber-200" role="alert">
        ...
        {(clientError || (error && !isUnverifiedAccount)) && (
          <div className="rounded-lg bg-red-50 p-4 border border-red-200" role="alert">
            <div className="flex items-start">
              ...
              <div className="ml-3">
                <p className="text-sm text-red-700">{clientError || error}</p>
              </div>
            </div>
          </div>
        )}
        ...
        <form className="mt-6 space-y-5" onSubmit={handleSubmit} noValidate>
          <div>
            ...
            <input
              ...
              disabled={isLoading}
              className="appearance-none block w-full px-3 py-2.5 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 text-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-sm disabled:bg-gray-100 disabled:cursor-not-allowed"
